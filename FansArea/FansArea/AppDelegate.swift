...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setNavAndTabBar() {
        //bar的颜色
        UINavigationBar.appearance().barTintColor = UIColor(red: 174/255, green: 0/255, blue: 126/255, alpha: 1)
        //bar上控件的颜色
        UINavigationBar.appearance().tintColor = UIColor.white
        //字体
        let dict:NSDictionary = [NSAttributedStringKey.foregroundColor: UIColor.white,NSAttributedStringKey.font : UIFont.boldSystemFont(ofSize: 22)]
        //标题颜色
